...
namespace HrSystemApp.Infrastructure.Migrations
{
    ...
    [Migration("20260314024154_AddNameAndMustChangePasswordToUser")]
    partial class AddNameAndMustChangePasswordToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompanyHierarchyPosition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Department", b =>
                {
                    ...
                    b.HasOne("Employee", "VicePresident")
                        .WithMany()
            ...
            modelBuilder.Entity("Employee", b =>
                {
                    ...
                    b.HasOne("CompanyLocation", "CompanyLocation")
                        .WithMany()
