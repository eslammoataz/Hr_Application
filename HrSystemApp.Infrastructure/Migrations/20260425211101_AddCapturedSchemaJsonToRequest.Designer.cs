...
namespace HrSystemApp.Infrastructure.Migrations
{
    ...
    [Migration("20260425211101_AddCapturedSchemaJsonToRequest")]
    partial class AddCapturedSchemaJsonToRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HrSystemApp.Domain.Models.Request", b =>
                {
                    ...
                    b.Property<string>("CapturedSchemaJson")
                        .HasColumnType("text");
                    ...
                    b.Property<Guid?>("RequestTypeId1")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HrSystemApp.Domain.Models.RequestType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("AllowExtraFields")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("DisplayNameLocalizationsJson")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("RequestNumberPattern")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("HrSystemApp.Domain.Models.Request", b =>
                {
                    ...
                    b.HasOne("HrSystemApp.Domain.Models.RequestType", "RequestType")
                        .WithMany()
                        .HasForeignKey("RequestTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("HrSystemApp.Domain.Models.RequestType", null)
                        .WithMany("Requests")
            ...
            modelBuilder.Entity("HrSystemApp.Domain.Models.RequestType", b =>
                {
                    b.Navigation("RequestDefinitions");
