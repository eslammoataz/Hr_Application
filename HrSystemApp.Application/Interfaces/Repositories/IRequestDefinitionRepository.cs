...
{
    Task<RequestDefinition?> GetByTypeAsync(Guid companyId, Guid requestTypeId, CancellationToken cancellationToken = default);
    Task<List<RequestDefinition>> GetByCompanyAsync(Guid companyId, Guid? requestTypeId = null, CancellationToken cancellationToken = default);
